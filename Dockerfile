...
RUN apt-get update \
    ...
    && curl -Lo /usr/local/share/ca-certificates/lets-encrypt-x3-cross-signed.crt https://letsencrypt.org/certs/lets-encrypt-x3-cross-signed.pem.txt # Get Let's Encrypt CA Bundle \
